      ...
      <div>
        ...
        <div className="flex flex-col pt-2 space-y-3">
          ...
          <div className="flex-grow flex-col space-y-1 animate-pulse">
            <div className="bg-gray-300 p-2 rounded w-4/5"></div>
      ...
      <div>
        ...
        <div className="flex flex-col pt-2 space-y-3">
          ...
          <div className="rounded animate-pulse flex space-x-2 items-center">
            <div className="flex-none rounded-full w-12 h-12 bg-gray-400"></div>
            <div className="flex-grow flex-col space-y-1">
              <div className="bg-gray-300 p-2 rounded"></div>
              <div className="bg-gray-300 p-2 rounded w-3/4"></div>
            </div>
          </div>{' '}
          <div className="rounded animate-pulse flex space-x-2 items-center">
            <div className="flex-none rounded-full w-12 h-12 bg-gray-400"></div>
